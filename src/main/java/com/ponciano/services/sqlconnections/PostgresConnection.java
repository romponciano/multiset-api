...
@Service
public class PostgresConnection extends SQLBaseConnection {
    ...
    public List<Attribute> listAllAttributes(String table) throws SQLException {
        String sql = "SELECT * from information_schema.columns WHERE table_schema = 'public' AND table_name = '{TABLE_NAME}'";
